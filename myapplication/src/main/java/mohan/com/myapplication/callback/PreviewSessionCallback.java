package mohan.com.myapplication.callback;
...
public class PreviewSessionCallback extends CameraCaptureSession.CaptureCallback implements CustomTextureView.FocusPositionTouchEvent {
    ...
    public PreviewSessionCallback(AnimationImageView mFocusImage, Handler mMainHandler, CustomTextureView mMyTextureView) {
