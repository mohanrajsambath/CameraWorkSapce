package mohan.com.myapplication.customviews;
...
import mohan.com.myapplication.activity.MainActivity;
import mohan.com.myapplication.utils.SleepThread;
...
public class AnimationImageView extends ImageView {
    ...
    public void startFocusing() {
        ...
        new Thread(new SleepThread(mMainHandler, MainActivity.FOCUS_DISAPPEAR, 1000, Integer.valueOf(mTimes))).start();
    }
