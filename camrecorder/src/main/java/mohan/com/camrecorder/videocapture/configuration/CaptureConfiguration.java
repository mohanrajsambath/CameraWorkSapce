package mohan.com.camrecorder.videocapture.configuration;
 ...
 * File Name : CaptureConfiguration.java.
 * ClassName : CaptureConfiguration.
 * QualifiedClassName : com.videocapture.configuration.CaptureConfiguration.
 * Module Name : app.
...
public class CaptureConfiguration implements Parcelable {
	...
	public CaptureConfiguration(CaptureResolution resolution, @NonNull CaptureQuality quality) {
		mVideoWidth = resolution.width;
		mVideoHeight = resolution.height;
		mBitrate = resolution.getBitrate(quality);
	}

	public CaptureConfiguration(@NonNull CaptureResolution resolution, @NonNull CaptureQuality quality, int maxDurationSecs,
                                int maxFilesizeMb) {
	...
	public static final Creator<CaptureConfiguration> CREATOR = new Creator<CaptureConfiguration>() {
		@Override
		public CaptureConfiguration createFromParcel(@NonNull Parcel in) {
