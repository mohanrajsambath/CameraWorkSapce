...
public class PreRecordingActivity extends AppCompatActivity implements View.OnClickListener {
    public Activity getActivityContext;
    public CustomTextureView mTextureView;
    public ImageView btnChangeCamera,imgVwRecLight,imgVwRecSolid;
